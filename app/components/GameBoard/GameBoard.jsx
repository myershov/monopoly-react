    ...
    return (
      <div className='wrapper'>
        <div className='gameboard'>
          <div className='top'>{top.map(i => <GameBoardCell {...i} />)}</div>
          <div className='left'>{left.map(i => <GameBoardCell {...i} />)}</div>
          <div className='center' />
          <div className='right'>{right.map(i => <GameBoardCell {...i} />)}</div>
          <div className='bottom'>{bottom.map(i => <GameBoardCell {...i} />)}</div>
        </div>
      </div>
    )
  }
